...
public class Assets {
    ...
    public final String victoryMusic = "sfx/Music/victory_music.ogg";
    public final String defeatMusic = "sfx/Music/defeat_music.ogg";
    public final String battleMusic = "sfx/battle_music.ogg";
    public final String creditsMusic = "sfx/credit_music.ogg";
    public final String stage1BattleMusic = "sfx/Music/stage1_battle_music.ogg";
    public final String stage2BattleMusic = "sfx/Music/stage2_battle_music.ogg";
    public final String stage3BattleMusic = "sfx/Music/stage3_battle_music.ogg";
    public final String lastBossBattle1Music = "sfx/Music/last_boss_1_battle_music.ogg";
    public final String lastBossBattle2Music = "sfx/Music/last_boss_2_battle_music.ogg";
    public final String lastBossBattle3Music = "sfx/Music/last_boss_3_battle_music.ogg";

    // sounds
    public final String castingSFX ="sfx/casting_sfx.ogg";
    public final String cdSFX ="sfx/SFX/cd_sfx.ogg";
    public final String hotSFX ="sfx/hot_sfx.ogg";
    public final String barrierSFX = "sfx/SFX/p_spells/barrier_sfx.ogg";
    public final String blessedGardenSFX = "sfx/SFX/p_spells/blessed_garden_sfx.ogg";
    public final String dispelSFX = "sfx/SFX/p_spells/dispel_sfx.ogg";
    public final String divineHymnSFX = "sfx/SFX/p_spells/divine_hymn_sfx.ogg";
    public final String divineProtectionSFX = "sfx/SFX/p_spells/divine_protection_sfx.ogg";
    public final String greaterHealSFX = "sfx/SFX/p_spells/greater_heal_sfx.ogg";
    public final String healSFX = "sfx/SFX/p_spells/heal_sfx.ogg";
    public final String holyNovaSFX = "sfx/SFX/p_spells/holy_nova_sfx.ogg";
    public final String holyShockSFX = "sfx/SFX/p_spells/holy_shock_sfx.ogg";
    ...
    public final String penanceHit3SFX = "sfx/SFX/p_spells/penance/penance_hit3_sfx.ogg";
    public final String penanceHit4SFX = "sfx/SFX/p_spells/penance/penance_hit4_sfx.ogg";
    public final String penanceTriggerSFX = "sfx/SFX/p_spells/penance/penance_trigger_sfx.ogg";
    //pom
    public final String pomHitSFX = "sfx/SFX/p_spells/pom/pom_hit_sfx.ogg";
    public final String pomTriggerSFX = "sfx/SFX/p_spells/pom/pom_trigger_sfx.ogg";
    // boss sounds
    public final String firecastSFX = "sfx/SFX/b_spells/firecast_sfx.ogg";
    public final String bigDebuffSFX = "sfx/SFX/b_spells/big_debuff_sfx.ogg";
    public final String bigFireballSFX = "sfx/SFX/b_spells/big_fireball_sfx.ogg";
    public final String debuffSFX = "sfx/SFX/b_spells/debuff_sfx.ogg";
    public final String explosionSFX = "sfx/SFX/b_spells/explosion_sfx.ogg";
    public final String finishImpactSFX = "sfx/SFX/b_spells/finish_impact_sfx.ogg";
    public final String fireBreathSFX = "sfx/SFX/b_spells/fire_breath_sfx.ogg";
    public final String fireballSFX = "sfx/SFX/b_spells/fireball_sfx.ogg";
    public final String unstableProblastSFX = "sfx/SFX/b_spells/u_pyroblast_sfx.ogg";
    public final String swordSwing1SFX = "sfx/SFX/b_spells/flurry/ss1_sfx.ogg";
    public final String swordSwing2SFX = "sfx/SFX/b_spells/flurry/ss2_sfx.ogg";
    public final String swordSwing3SFX = "sfx/SFX/b_spells/flurry/ss3_sfx.ogg";
    public final String swordSwing4SFX = "sfx/SFX/b_spells/flurry/ss4_sfx.ogg";
    public final String swordSwing5SFX = "sfx/SFX/b_spells/flurry/ss5_sfx.ogg";
    public final String swordSwing6SFX = "sfx/SFX/b_spells/flurry/ss6_sfx.ogg";
    public final String earthquake1SFX = "sfx/SFX/b_spells/earthquake/earthquake1_sfx.ogg";
    public final String earthquake2SFX = "sfx/SFX/b_spells/earthquake/earthquake2_sfx.ogg";
    public final String earthquake3SFX = "sfx/SFX/b_spells/earthquake/earthquake3_sfx.ogg";
    public final String chargeSFX = "sfx/SFX/b_spells/charge_sfx.ogg";
    public final String biteSFX = "sfx/SFX/b_spells/bite_sfx.ogg";
    public final String stabSFX = "sfx/SFX/b_spells/stab_sfx.ogg";
    public final String magicStabSFX = "sfx/SFX/b_spells/magic_stab_sfx.ogg";
    public final String darkMagicSFX = "sfx/SFX/b_spells/dark_magic_sfx.ogg";
    public final String electricStrikeSFX = "sfx/SFX/b_spells/electric_strike_sfx.ogg";
    ...
    public final String miniBossIcon = "icons/level_mini_boss.png";
    public final String bossIcon = "icons/level_boss.png";
    ...
    public final String resurgenceIcon = "icons/resurgence_icon.png";
    ...
    public final String battleBg1 = "encounter_state/battle_bg1.png";
    public final String battleBg2 = "encounter_state/battle_bg2.png";
    ...
    public final String redBar = "red_bar.png";
    public final String redOutlineBar = "red_outline_bar.png";
    public final String greenBar = "green_bar.png";
    ...
    public final String castBar = "casting_bar.png";
    public final String cooldownBar = "cooldown_bar.png";
    ...
    public final String defeatedBossIcon = "map_state/defeated_boss.png";
