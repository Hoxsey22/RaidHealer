...
public class TalentTree extends Group{
    ...
    private void createTalents()  {
        ...
        talents.add(new Talent(this, 3, RENEWING_NOVA, "Holy Nova will be reduced by 60%, but will place strong Renews, but will have a cooldown. Flash Heal will now leave a Renew.", talents.get(talents.size()-1),
